...
import com.example.pokedex.data.api.RetrofitClient.pokemonApiService
...
class PokedexViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        loadPokemonApi(pokemonName = "druddigon")
    }

    private fun loadPokemonApi(pokemonName: String) {
        viewModelScope.launch {
            try {
                val pokemon = pokemonApiService.getPokemonInfo(pokemonName)
